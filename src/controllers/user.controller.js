...
const updateUserProfile = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const profile_pic = req.file ? `${validate_env_1.default.API_URL}/media/profiles/${req.file.filename}` : undefined;
        ...
        if (req.file) {
            if (existingUser.profile_pic) {
                const removeMediaResponse = (0, file_service_1.removeMediaFile)(existingUser.profile_pic);
                if (!removeMediaResponse.success) {
                    yield transaction.rollback();
                    return (0, http_status_1.sendBadRequestResponse)(res, removeMediaResponse.message);
                }
                yield media_service_1.default.updateUserProfilePicture(user_id, req.file, transaction);
            }
            else {
